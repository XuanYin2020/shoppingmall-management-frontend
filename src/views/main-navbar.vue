  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">Management System</a>
        <a class="site-navbar__brand-mini" href="javascript:;">Back-End</a>
      </h1>
    </div>
    <div class="site-navbar__body clearfix">
      ...
      <el-menu
        ...
        <el-menu-item index="2">
          <el-badge value="hot">
            <a href="http://shoppingmall.com/" target="_blank">Client WebPage</a>
          </el-badge>
        </el-menu-item>
        <!-- <el-submenu index="3">
